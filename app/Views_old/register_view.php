...
<body id="kt_body" class="bg-body">
					...
					<form class="form w-100" novalidate="novalidate" id="kt_sign_up_form">
						...
						<div class="mb-10 text-center">
							...
							<div class="text-gray-400 fw-bold fs-4">Already have an account?
								<a href="<?= base_url("login") ?>" class="link-primary fw-bolder">Sign in
									here</a>
								</div>
								<!--end::Link-->
								</div>
						...
						<form action="<?= base_url("register/process") ?>" method="post">
							...
							<div class="row fv-row mb-7">
								<!--begin::Col-->
								<div class="col-xl-6">
									<label class="form-label fw-bolder text-dark fs-6">First
										Name</label>
									<input class="form-control form-control-lg form-control-solid"
										type="text" placeholder="F. Name" name="first-name"
										autocomplete="off" />
								</div>
							</div>
							<!--end::Col-->
							...
							<div class="row fv-row mb-7">
								<div class="col-xl-6">
									<label class="form-label fw-bolder text-dark fs-6">Last
										Name</label>
									<input class="form-control form-control-lg form-control-solid"
										type="text" placeholder="L.Name" name="last-name"
										autocomplete="off" />
								</div>
							</div>
							<!--end::Col-->
							...
							<div class="fv-row mb-7">
								...
								<input class="form-control form-control-lg form-control-solid"
									type="email" placeholder="test@validEmail.com" name="email"
									autocomplete="off" />
							</div>
							<!--end::Input group-->
							<!--begin::Input group-->
							<div class="mb-10 fv-row" data-kt-password-meter="true">
								...
								<div class="mb-1">
									<!--begin::Label-->
									<label
										class="form-label fw-bolder text-dark fs-6">Password</label>
									<!--end::Label-->
									<!--begin::Input wrapper-->
							...
							<div class="fv-row mb-10">
								<label
									...
									<input class="form-check-input" type="checkbox" name="toc"
										value="1" />
									<span class="form-check-label fw-bold text-gray-700 fs-6">I
										Agree with the
										<a target="blank" href="" class="ms-1 link-primary">Terms
	...
	<!--end::Main-->
	<script>var hostUrl = realpath("./assets/");</script>
	<!--begin::Javascript-->
