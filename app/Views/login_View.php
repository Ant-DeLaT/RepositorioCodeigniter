...
<body id="kt_body" class="bg-body">
	...
	<div class="d-flex flex-column flex-root">
		...
		<div
			...
			<div
				...
				<a href="#" class="mb-12">
					<img alt="Logo"
						src="<?php echo base_url('assets/media/logos/logo-1.svg'); ?>"
						class="h-40px" />
					</a>
					<!--end::Logo-->
	...
	<script
		src="<?php echo ('public/assets/plugins/global/plugins.bundle.js'); ?>"></script>
	<script src="<?= ('public/assets/js/scripts.bundle.js') ?>"></script>
	<!--end::Global Javascript Bundle-->
	<!--begin::Page Custom Javascript(used by this page)-->
	<script
		src="<?= ('assets/js/custom/authentication/sign-in/general.js') ?>"></script>
