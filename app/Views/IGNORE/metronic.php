									...
									<div class="container-fluid">
										...
										<div class="card card-xl-stretch">
											...
											<div class="card-header border-0 bg-danger py-5">
												<h3 class="card-title fw-bolder text-white">Sales Statistics, POSSIBLE USE</h3>
								...
								<div class="row container-fluid">
									...
									<div class="col-xl-6">
										...
										<div class="card card-xl-stretch mb-xl-6">
											<!--begin::Header-->
											<div class="card-header border-0">
												<h3 class="card-title fw-bolder text-dark">Notifications MIGHT</h3>
												<div class="card-toolbar">
													<!--begin::Menu-->
													<button type="button" class="btn btn-sm btn-icon btn-color-primary btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
														<!--begin::Svg Icon | path: icons/duotune/general/gen024.svg-->
								...
								<div class="g-5 gx-xl-8">
									...
									<div class="card card-xl-stretch">
										...
										<div class="card-header">
											...
											<div class="card-toolbar">
												<a href="LINK2CALENDARBASE" class="btn btn-primary">Manage Calendar</a>
											</div>
										</div>
										<!--end::Card header-->
										<!--begin::Card body-->
					...
					<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<ul class="menu menu-gray-600 menu-hover-primary fw-bold order-1">
								...
								<li class="menu-item">
									<a href="<?= base_url('/FAQ') ?>" target="_blank" class="menu-link px-2">FAQ</a>
								</li>
							</ul>
							<!--end::Menu-->
						</div>
