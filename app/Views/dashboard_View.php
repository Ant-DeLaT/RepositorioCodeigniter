...
<<<<<<< Updated upstream
                        <div class="aside-footer flex-column-auto pt-5 pb-7 px-5"
                            ...
                            <a class="btn btn-custom btn-primary w-100" href="#"
                                ...
                                data-bs-dismiss-="click"
                                title='Click here to access your user data!'>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.2.7/vfs_fonts.js"
    ...
    crossorigin="anonymous"></script>
<script
    src="https://cdn.datatables.net/v/bs5/jq-3.7.0/moment-2.29.4/jszip-3.10.1/dt-2.2.2/af-2.7.0/b-3.2.2/b-html5-3.2.2/cr-2.0.4/date-1.5.5/kt-2.12.1/r-3.0.4/rg-1.5.1/sb-1.8.2/sp-2.3.3/sl-3.0.0/sr-1.4.1/datatables.min.js"
    integrity="sha384-lOStfB9w51cCYrPxeiPDDu13j3XyuozGjSybjRQ11umFeuaLhi+QFjYfTR4e2VOw"
    crossorigin="anonymous"></script>
<script
